...
FLARE_ALERT_MAP = {'XRSA>5e-7 W/m<sup>2</sup>':xrs_condition, 
                   'Temp>0.05':temp_condition,
                   'Emission Measure>3e48 cm<sup>-3</sup>':em_condition,
                   '3-minute XRSA Increase>1e-8 W/m<sup>2</sup>':xrsa_3mindiff_condition} #